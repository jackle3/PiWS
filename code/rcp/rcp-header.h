...
#define RCP_MAX_PAYLOAD 21   /* Maximum payload size to fit in 32-byte NRF packet */
...
static inline void rcp_set_flag(struct rcp_header *hdr, uint8_t flag) { hdr->flags |= flag; }

static inline void rcp_clear_flag(struct rcp_header *hdr, uint8_t flag) { hdr->flags &= ~flag; }
